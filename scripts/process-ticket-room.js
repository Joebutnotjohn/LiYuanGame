/**
 * process-ticket-room.js
 *
 * 处理 public/assets/ticket-room 目录下的 PNG 图片：
 * - 去除白底/浅色背景（复用 remove-npc-bg.js 的核心算法）
 * - 输出到 public/processed/ticket-room/
 *
 * 用法：
 *   node scripts/process-ticket-room.js
 */
...
// ==============================
async function main() {
  console.log('=== Ticket-room 图片去背景工具 ===')
