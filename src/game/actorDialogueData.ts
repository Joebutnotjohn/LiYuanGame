...
const CHENG_XIAOWAN: ActorDialogue = {
  ...
  greeting: '呀，班主~妾身正在描眉，您找我有何吩咐？（微微欠身）',
  responses: [
    {
    ...
    },
    {
      ...
      answers: [
        '妾身今日饰虞姬~一袭素衣，备好剑与酒，与霸王做最后的诀别……',
        '虞姬啊~这出戏唱的是诀别，唱的是心死。妾身每次登台，都要再死一次呢。',
        '今日《霸王别姬》，霸王与虞姬的最后一夜。妾身已揣摩多日了。',
      ],
      affinityGain: 2,
      tag: '今日剧目',
    },
    {
      ...
      answers: [
        '裴师兄的剑花练得可俊了！妾身最盼与他同台那一段"虞姬舞剑"。',
        '霸王气概，需裴师兄那般的嗓子与身段方能撑得起。妾身仰慕已久。',
        '他舞剑时眼神如电，妾身每每接戏都怕被他那眼神摄住呢~',
      ],
      affinityGain: 1,
      tag: '议论同行',
    },
    {
      ...
      answers: [
        '妾身自幼练"跷功"，脚尖点地的功夫一练就是十年呐。',
        '花旦讲究"手眼身法步"，光一个眼神就要练上半年。',
        '台上一分钟，台下十年功。班主若有空，妾身可以为您演示一段~',
      ],
      affinityGain: 2,
      tag: '讨论技艺',
    },
    ...
    },
    {
      ...
      answers: [
        '妾身最爱"夜深沉"那段曲牌，胡琴一起，便觉魂入戏中。',
        '若能演一出《贵妃醉酒》，便是妾身毕生之愿了~',
      ],
      affinityGain: 2,
      tag: '心事',
    },
    ...
    },
    {
      ...
      answers: [
        '诀别那段，妾身要先笑，再舞剑，最后横剑自刎……观众流泪时，妾身心里也在哭。',
  ...
  affinityLines: [
    {
      threshold: 5,
      lines: [
        '（轻声）班主……妾身平日里很少与人说这些的，您倒让妾身觉得贴心。',
        '班主，今日妾身心情甚好，愿为您唱一段《霸王别姬》的"看大王"可好？',
      ],
    },
    {
      threshold: 10,
      lines: [
        '（眼眶微红）班主待妾身这样好，妾身……此生定不忘梨园知遇之恩。',
        '班主，妾身有一事相托——若妾身日后唱红了，定要在戏单上写上您的名字。',
      ],
    },
    {
      threshold: 20,
      lines: [
        '（握紧手中帕子）班主，妾身从未把任何人放在心里过，您是头一个。',
        '班主……妾身不敢说出口，但您懂的，对吗？',
      ],
    },
    {
      threshold: 35,
      lines: [
        '（低头）班主，您若不嫌……妾身愿为您守这戏园一辈子。',
        '妾身此生只愿与班主同台，纵粉身碎骨，亦无悔。',
      ],
    },
  ],
  rejection: [
